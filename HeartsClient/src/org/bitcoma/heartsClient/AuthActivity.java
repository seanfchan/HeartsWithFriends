    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getInfo.setOnClickListener(new OnClickListener()
        {
            ...
            public void onClick(View v) {
               ...
               if (password1.length() == 0 || emailAddress.length() == 0 || userName.length() == 0 || password2.length() == 0)
               {
               ...
               if (password1.compareTo(password2) == 0 && userName.contains("@") == false)
               {
                   ...
                   Toast.makeText(getApplicationContext(), userName + " " + emailAddress + " " + password, Toast.LENGTH_SHORT).show();
