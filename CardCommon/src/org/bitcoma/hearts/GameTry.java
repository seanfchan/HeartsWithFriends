...
public class GameTry {
    ...
    // players.add(new BotPlay((long) 1,
    // myGame.currentRound.getUserIdToHand().get((long) 1)));
    // players.add(new BotPlay((long) 2,
    // myGame.currentRound.getUserIdToHand().get((long) 2)));
    // players.add(new BotPlay((long) 3,
    // myGame.currentRound.getUserIdToHand().get((long) 3)));
    // players.add(new BotPlay((long) 4,
    // myGame.currentRound.getUserIdToHand().get((long) 4)));
    //
    // int i = 0;
    ...
    // boolean result = startTrick.isMoveValid(played, first.getBotCards());
    // if (result) {
    ...
    // Card played2 = players.get(nextPlayer).playCard(played.getSuit(),
    // soFarTrick);
    // System.out.println("Bot " + players.get(nextPlayer).playerId + " played "
    // + played2);
    // result = startTrick.isMoveValid(played2,
    // players.get(nextPlayer).getBotCards());
    // if (result) {
    // startTrick.makeMove(players.get(nextPlayer).playerId, played2);
    // myGame.currentRound.removeCard(players.get(nextPlayer).playerId,
    // played2);
    // }
    // soFarTrick.add(played2);
    //
    // nextPlayer = (nextPlayer + 1) % 4;
    // Card played3 = players.get(nextPlayer).playCard(played.getSuit(),
    // soFarTrick);
    // System.out.println("Bot " + players.get(nextPlayer).playerId + " played "
    // + played3);
    // result = startTrick.isMoveValid(played3,
    // players.get(nextPlayer).getBotCards());
    // if (result) {
    ...
    //
    // nextPlayer = (nextPlayer + 1) % 4;
    // Card played4 = players.get(nextPlayer).playCard(played.getSuit(),
    // soFarTrick);
    // System.out.println("Bot " + players.get(nextPlayer).playerId + " played "
    // + played4);
    // result = startTrick.isMoveValid(played4,
    // players.get(nextPlayer).getBotCards());
    // if (result) {
    ...
    // System.out.println("Loser of the trick is " + loser + " gets " +
    // penalty);
    //
    // myGame.userIdToGameScore.put(loser, (byte)
    // (myGame.userIdToGameScore.get(loser) + penalty));
    ...
    // myGame.userIdToGameScore.get(id));
    // }
    // System.out.println("\n");
